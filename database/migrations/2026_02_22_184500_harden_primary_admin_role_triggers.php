...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::unprepared(<<<'SQL'
            ...
            FOR EACH ROW
            BEGIN
                IF OLD.model_type = CONCAT('App', CHAR(92), 'Models', CHAR(92), 'User')
                   AND OLD.model_id = 1 THEN
        ...
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                IF NEW.model_type = CONCAT('App', CHAR(92), 'Models', CHAR(92), 'User')
                   AND NEW.model_id = 1
            ...
            BEGIN
                IF NEW.model_type = CONCAT('App', CHAR(92), 'Models', CHAR(92), 'User')
                   ...
                   AND EXISTS (
                       ...
                       WHERE model_type = CONCAT('App', CHAR(92), 'Models', CHAR(92), 'User')
                         AND model_id = 1
                   ) THEN
                    SIGNAL SQLSTATE '45000'
                    SET MESSAGE_TEXT = 'Role assignment for user #1 is protected and cannot be changed.';
